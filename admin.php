      ...
      <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <?php foreach ($query as $admin): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    class="btn btn-sm btn-dark" onclick='Edit(<?php echo json_encode($admin);?>)'>
                                        Edit
                                    </button>
                ...
                <button type="button" class="btn btn-dark text-white float-right" style="margin-left: 15px;" data-toggle="modal"
